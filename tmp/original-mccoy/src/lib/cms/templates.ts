...
export const TEMPLATES: TemplateDef[] = [
  ...
  },
  {
    ...
    description: "Grote quote met naam, functie, bedrijf en foto.",
    category: "Content",
    icon: Quote,
    defaultData: {
  ...
  },
  {
    type: "gallery",
    name: "Foto galerij",
    description: "Grid, masonry of carrousel-galerij.",
    category: "Media",
    icon: Grid3x3,
    defaultData: {
  ...
  {
    type: "fullImage",
    name: "Volledige afbeelding",
    description: "Groot beeld met optionele overlay-tekst.",
    category: "Media",
    icon: ImageIcon,
    defaultData: { image: "", caption: "", overlayTitle: "" },
  },
  {
    type: "video",
    name: "Video sectie",
  ...
  },
  {
    ...
    defaultData: {
      ...
      milestones: [
        { year: "2018", title: "Oprichting", body: "Start van het bedrijf." },
        { year: "2021", title: "Groei", body: "Uitbreiding naar regio Twente." },
        { year: "2024", title: "Nieuw pand", body: "Verhuizing naar een groter kantoor." },
      ],
    },
  },
  {
  ...
  {
    type: "newsletter",
    name: "Nieuwsbrief signup",
    description: "Titel, beschrijving, e-mailveld, knop en consent.",
    category: "Conversion",
    icon: Mail,
    defaultData: {
      title: "Blijf op de hoogte",
      body: "Ontvang onze updates in je inbox.",
      buttonLabel: "Aanmelden",
      consent: "Door aan te melden ga je akkoord met onze voorwaarden.",
    },
  },
  {
    type: "contactForm",
    name: "Contactformulier",
    description: "Instelbare velden, ontvanger, bevestiging en optionele kaart.",
    category: "Conversion",
    icon: Send,
    defaultData: {
      ...
      confirmation: "Bedankt! We reageren binnen 24 uur.",
    },
  },
  {
    type: "announcement",
  ...
  },
  {
    type: "popup",
    name: "Popup CTA",
    description: "Herbruikbare modal voor aanbiedingen of aankondigingen.",
    category: "Conversion",
    icon: MousePointerClick,
    defaultData: {
      title: "Speciale aanbieding",
      body: "10% korting op je eerste opdracht.",
  ...
  },
  {
    ...
    description: "Automatisch de meest recente artikelen tonen.",
    category: "Showcase",
    icon: Newspaper,
    defaultData: {
      title: "Laatste nieuws",
      posts: [
        { title: "Voorbeeld artikel 1", excerpt: "Korte samenvatting.", date: "2026-01-01" },
        { title: "Voorbeeld artikel 2", excerpt: "Korte samenvatting.", date: "2026-02-15" },
      ],
    },
  },
];
