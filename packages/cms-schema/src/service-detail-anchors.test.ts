...
describe("service detail anchors", () => {
  ...
  it("maps default CMS card and footer ids to those hashes", () => {
    ...
    expect(SERVICE_DETAIL_ANCHOR_BY_FOOTER_LINK_ID.footer_svc_1).toBe("reguliere-schoonmaak");
    expect(SERVICE_DETAIL_ANCHOR_BY_FOOTER_LINK_ID.footer_svc_6).toBe("glas-gevelreiniging");
